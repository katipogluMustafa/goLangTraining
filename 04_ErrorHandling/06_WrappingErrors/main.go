// Sample Program to show how wrapping errors works
...
func (e *AppError) Error() string {
	return fmt.Sprintf("App Error, State: %d", e.State)
}
...
// secondCall makes a call to third function and wraps any error.
