/* How strings have a UTF-8 encoded byte array. */
package main
...
func main() {
	...
	for i, r := range s {
		...
		// Display the details for this rune.
...
/*
 * Slicing a string will create a new string value.
 */
 ...
 * No guarantee is made in Go that characters in string are normalized
 - - - - - - - - - - - - - - - - - - - - - -
